...
public class FeedbackWebSocketHandler extends BinaryWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        String uri = session.getUri().toString();  // URL 경로 추출. ws://localhost:8080/ws/feedback/1 반환됨.
    ...
    public int getActiveSessions(Long roomId) {
        return roomSessions.getOrDefault("/ws/feedback/" + roomId, Set.of()).size();
    }
